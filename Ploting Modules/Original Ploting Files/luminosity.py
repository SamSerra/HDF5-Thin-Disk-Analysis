...
f2 = [np.array(line.split()).astype('float') for line in open(r'C:\Users\samps\Desktop\Py Scripts Project\Data\alpha','r')] #for line in open('../shakura_1E_PP/luminosity','r')]
f3 = [np.array(line.split()).astype('float') for line in open(r'C:\Users\samps\Desktop\Py Scripts Project\Data\alpha','r')] #for line in open('../shakura_3E_PP/luminosity','r')]
f4 = [np.array(line.split()).astype('float') for line in open(r'C:\Users\samps\Desktop\Py Scripts Project\Data\alpha','r')] #for line in open('../shakura_3Ep_PP/luminosity','r')]
